...
import { abi } from "../contracts/ATATO.json";
...
export default function Minter() {
  ...
  const { mintNft,resolveLink } = useIPFS();
  ...
  const mintAndGo = async () => {
    ...
    console.log("2222222", cid);
    const minter = await Moralis.executeFunction({
      functionName: "mint",
      abi,
      contractAddress: "0xC415139089E206e70EbDF8C6F5Ec54e93Fbf21cA",
      params: {
        _tokenURI,
        // data: []
      },
